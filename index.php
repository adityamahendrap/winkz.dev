  ...
  <body oncontextmenu="return false">
    ...
    <main class="main">
        ...
        <div class="home-container container grid">
          <div class="home-content grid">
            <div class="home-social">
              ...
              <a
                href="https://github.com/adityamahendrap"
                target="_blank"
            ...
            <div class="home-img">
              ...
              <lottie-player
                src="https://lottie.host/7190e2aa-7c66-4942-b6b4-7ea82a9cb5f5/ITE9Lh6saT.json"
                background="##fff"
                speed="1"
      ...
      <section class="about section" id="about">
        ...
        <span class="section-subtitle" style="padding: 0rem 0.5rem;"
          >I hope you can get to know me better through this short
          introduction</span
        >
      ...
      <section class="skills section" id="skills">
        ...
        <div style="display: flex; justify-content: center; gap: 1rem;">
          ...
          <!-- <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 128 128" id="vuejs"><path fill="none" d="m-2.3125e-8 8.9337 49.854 0.1586 14.167 24.47 14.432-24.47 49.547-0.1577-63.834 110.14zm126.98 0.6374-24.36 0.0207-38.476 66.052-38.453-66.052-24.749-0.0194 63.211 107.89zm-25.149-0.008-22.745 0.16758l-15.053 24.647-14.817-24.647-22.794-0.1679 37.731 64.476zM25.997 9.3929l23.002 0.0087M25.997 9.3929l23.002 0.0087"></path><path fill="#35495e" d="m25.997 9.3929 23.002 0.0087l15.036 24.958 14.983-24.956 22.982-0.0057-37.85 65.655z"></path><path fill="#41b883" d="m0.91068 9.5686 25.066-0.1711 38.151 65.658 37.852-65.654 25.11 0.0263-62.966 108.06z"></path></svg> -->
      ...
      <section class="portfolio section" id="portfolio">
        ...
        <span class="section-subtitle">My most recent work</span>

        <div class="portfolio-container container swiper-container">
          <div class="swiper-wrapper">
            <!-- ------------------------portfollio 1-------------------- -->
            <div class="portfolio-content grid swiper-slide">
              <img src="assets/img/itcc.png" class="portfolio-img" />

              <div class="portfolio-data">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="nuxt-dot-js"><path d="m19.62 18.94-5.31-9.43 5.44 9.7c-.04-.09-.08-.18-.13-.27z"></path><path fill="#3B8070" d="M23.85 20.36c-.35.61-1.12.64-1.27.64h-3.44c.72 0 1.17-.78.82-1.41l-.01-.01h2.55l-6.94-12.3-1.25 2.23-.81-1.43.91-1.61c.36-.65.82-.79 1.14-.79.7 0 1.11.66 1.18.79l7.02 12.49c.37.65.26 1.12.1 1.4z"></path><path fill="#41B883" d="m13.5 8.08-.81 1.43L9.93 4.6 1.5 19.58H7l-.01.01c-.36.63.1 1.41.82 1.41H1.4c-.75 0-1.09-.33-1.25-.61-.35-.61.01-1.3.08-1.43L8.77 3.79c.37-.65.82-.79 1.14-.79.7 0 1.11.66 1.18.78l2.41 4.3z"></path><path d="m19.615 18.784.001.002z"></path><ellipse cx="19.853" cy="19.408" rx=".007" ry=".001"></ellipse><path d="m19.624 18.8-.008-.014.003.006zM19.76 19.24c.04.11.08.22.1.34h.09l-.19-.34zm-12.59.34v-.02c.04-.22.11-.42.21-.6l5.18-9.21L7 19.58h.17z"></path><path fill="#35495E" d="m19.96 19.59-.01-.01h-.09c-.02-.12-.06-.23-.1-.34l-.01-.03-5.44-9.7-.81-1.43-.81 1.43-.13.24-5.18 9.21c-.1.18-.17.38-.21.6v.02H7l-.01.01c-.36.63.1 1.41.82 1.41h11.33c.72 0 1.17-.78.82-1.41zm-11.32-.01 4.86-8.64 4.86 8.64H8.64z"></path></svg>
                ...
                <div class="btn-portfolio">
                  ...
                  <a
                    href="https://itcc.hmtiudayana.id"
                    class="button button--flex button--small portfolio-button"
                  >
                    See Live
                    <i class="uil uil-external-link-alt button-icon"></i>
            ...
            <!-- ------------------------portfollio 2-------------------- -->
            <div class="portfolio-content grid swiper-slide">
              <img src="assets/img/bpjs.png" class="portfolio-img" />
              ...
              <div class="portfolio-data">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" enable-background="new 0 0 64 64" viewBox="0 0 64 64" id="openai"><path d="M24,16.14l14.72-8.5c0.01,0,0.01-0.01,0.02-0.01c-0.58-1.16-1.34-2.21-2.25-3.12C34.32,2.34,31.32,1,28,1
                    c-6.62,0-11.99,5.36-12,11.98c0,0.01,0,0.01,0,0.02v17l7.97,4.62L24,16.14z"></path><path d="M7.546,36.356l14.722,8.5l7.986-4.592l-15.989-9.266L14.264,14c0.005-0.009-0.004-0.014,0.001-0.022
                    c-1.295-0.078-2.584,0.055-3.827,0.389c-2.964,0.794-5.625,2.722-7.285,5.598c-3.31,5.733-1.353,13.064,4.375,16.382
                    C7.537,36.351,7.537,36.351,7.546,36.356z"></path><path d="M38.284,37.644l-16.019,9.214L7.544,38.36c-0.005-0.009-0.014-0.004-0.019-0.012c-0.715,1.082-1.244,2.266-1.577,3.509
                    c-0.794,2.964-0.455,6.232,1.205,9.108c3.31,5.733,10.637,7.704,16.375,4.402c0.009-0.005,0.009-0.005,0.017-0.01l14.722-8.5
                    L38.284,37.644z"></path><path d="M40,47.86l-14.72,8.5c-0.01,0-0.01,0.01-0.02,0.01c0.58,1.16,1.34,2.21,2.25,3.12C29.68,61.66,32.68,63,36,63
                    c6.62,0,11.99-5.36,12-11.98c0-0.01,0-0.01,0-0.02V34l-7.97-4.62L40,47.86z"></path><path d="M56.472,27.654c-0.009-0.005-0.009-0.005-0.017-0.01l-14.722-8.5l-7.986,4.592l15.989,9.266L49.736,50
                    c-0.005,0.009,0.004,0.014-0.001,0.022c1.295,0.078,2.584-0.055,3.827-0.389c2.964-0.794,5.625-2.722,7.285-5.598
                    C64.157,38.303,62.2,30.972,56.472,27.654z"></path><path d="M56.456,25.64c0.005,0.009,0.014,0.004,0.019,0.012c0.715-1.082,1.244-2.265,1.577-3.509
                    ...
                    l-0.016,9.212l16.019-9.214L56.456,25.64z"></path></svg>
                ...
                <div class="btn-portfolio">
                  <a
                    href="https://github.com/sungut-lele-dev/chatbot-bpjs"
                    class="button button--flex button--small portfolio-button"
                  >
                    GitHub Repository
                    <i class="uil uil-external-link-alt button-icon"></i>
            ...
            <div class="portfolio-content grid swiper-slide">
              ...
              <div class="portfolio-data">
                ...
                <div class="btn-portfolio">
                  <a
                    href="https://github.com/adityamahendrap/glammerce-next"
                    class="button button--flex button--small portfolio-button"
                  >
                    GitHub Repository
                    <i class="uil uil-external-link-alt button-icon"></i>
      ...
      <section class="contact section" id="contact">
        ...
        <div class="contact-container container grid">
            ...
            <div class="contact-information">
              ...
              <div>
                ...
                <span class="contact-subtitle"
                  ><a href="tel:6362243314"></a>089605106969</span
                >
              </div>
            </div>
          ...
          <form action="create_inbox.php" class="contact-form grid" method="POST" onsubmit="return validateForm()">
